...
import Base: @_inline_meta, axes, getindex, unsafe_getindex, convert, prod, *, /, \, +, -,
                ...
                findall, searchsortedfirst, diff, minimum, maximum, extrema, all, isreal
...
import ContinuumArrays: Basis, Weight, basis_axes, @simplify, AbstractAffineQuasiVector, ProjectionFactorization,
    ...
    plan_grid_transform, plan_transform, MAX_PLOT_POINTS, MulPlan, ApplyPlan, grammatrix, AdjointBasisLayout, grammatrix_layout, plan_transform_layout, _cumsum, uplus_size, uplus_components_basis
