...
copy(L::Ldiv{L1,L2}) where {L1<:AbstractNormalizedOPLayout, L2<:WeightedOPLayout{<:AbstractNormalizedOPLayout}} = copy(Ldiv{ApplyLayout{typeof(*)},ApplyLayout{typeof(*)}}(L.A, L.B))
