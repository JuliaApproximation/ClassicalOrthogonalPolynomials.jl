...
grid(Q::SubQuasiArray{<:Any,2,<:Normalized,<:Tuple{Inclusion,AbstractUnitRange}}) = grid(view(parent(Q).P, parentindices(Q)...))
plotgrid(Q::SubQuasiArray{<:Any,2,<:Normalized,<:Tuple{Inclusion,AbstractUnitRange}}) = plotgrid(view(parent(Q).P, parentindices(Q)...))
